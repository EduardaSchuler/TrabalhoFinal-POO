...
public class Aplicacao extends JFrame {
    ...
    public ArrayList<Album> getListaAlbuns() {
        return (ArrayList<Album>) listaArtistas.stream()
                .flatMap(artista -> artista.getAlbuns().stream())
    ...
    public void populaApp(){
        ...
        playlist = new Playlist("Mixed Playlist");
